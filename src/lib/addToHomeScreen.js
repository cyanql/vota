...
ath.intl = {
    ...
    zh_cn: {
        ios: '为了更良好的使用体验,请点击%icon, 然后<strong>添加到主屏幕</strong>',
        android: 'To add this web app to the home screen open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>'
    },
...
ath.language = ath.language && ath.language in ath.intl
    ? ath.language
    : 'en_us';
...
ath.OSVersion = ath.OSVersion && ath.OSVersion[2]
...
ath.Class.prototype = {
    ...
    show: function(force) {
        ...
        this.element.className = 'ath-container ath-' + ath.OS + ' ath-' + ath.OS + (parseInt(ath.OSVersion) || '') + ' ath-' + (ath.isTablet
            ? 'tablet'
            : 'phone');
    ...
    updateViewport: function() {
        ...
        var screenWidth = ath.OS == 'ios'
            ? this.orientation == 'portrait'
                ...
                : screen.height
            : screen.width;
        this.scale = screen.width > clientWidth
            ? 1
